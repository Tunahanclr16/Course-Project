...
export default function Brands() {
  return (
    <div className=" mt-[30px] md:p-2 sm:mt-[100px] mx-auto flex flex-wrap justify-center items-center gap-8 lg:max-w-[1595px] sm:max-w-[1279px] max-w-[300px] xs:max-w-[327px]">
