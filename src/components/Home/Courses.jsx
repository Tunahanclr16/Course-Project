      ...
      {courseData.slice(0,4).map((course, i) => (
          ...
          >
            ...
            <div className="flex flex-col pl-4 md:pl-9 mt-[30px] sm:mt-[40px] lg:mt-[50px]">
              <img className=" w-[309px] h-[172px] sm:h-[266px] sm:w-[472px] lgg:w-[683px] rounded-lg lgg:h-[450px]" src={course.image} alt="" />
            ...
            {course.level}
              ...
              <div className="text-[16px] mt-2 sm:pr-16 font-semibold  sm:mt-8  text-grey-15">
                {course.teacher}
              </div>
            </div>
             ...
             <h3 className="font-semibold  text-[20px] lg:text-[24px]  ">
              ...
              <p className="lg:mt-[14px] mt-[10px]   sm:text-[16px] text-[14px] lg:text-[18px]   max-w-[298px] sm:max-w-[429px] lgg:max-w-[688px] ">
                {course.description}
              </p>
             </div>
             <div className=" mt-[24px]  lg:mt-[30px]">
              <button className="text-grey-15 cursor-pointer bg-white-97 border-none rounded  text-[14px] lg:text-[18px] lgg:w-[683px] lgg:h-[63px] sm:w-[529px] w-[309px] h-[49px]">
                Get it Now 
              </button>
             </div>
            </div>
