...
export default function Courses() {
  ...
  return (
    <div className=" lgg:w-[1596px] lg:w-[1200px] w-[300px] xs:w-[360px] sm:w-[750px] mx-auto mt-[50px] sm:mt-[100px]">
      ...
      <div className="grid-cols-1 lg:grid-cols-2 grid mx-auto gap-11 sm:gap-20 mt-[40px] sm:mt-[60px] lg:mt-[80px]">
        {courseData.slice(0, 4).map((course, i) => (
          <div
            key={i}
            className="bg-[#FFFFFF] mx-auto shadow-xl items-center flex flex-col gap-20 justify-center sm:w-[502px] sm:h-[613px] h-[533px] lgg:h-[807px] lgg:w-[783px]"
          >
            <div className="flex flex-col pl-4 md:pl-9 mt-[30px] sm:mt-[40px] lg:mt-[50px]">
              <img
                className="w-[309px] mx-auto h-[172px] sm:h-[266px] sm:w-[472px] lgg:w-[683px] rounded-lg lgg:h-[450px]"
                src={course.image}
                alt=""
              />
              <div className="flex justify-between flex-col sm:flex-row max-w-[200px] sm:max-w-[649px]  sm:items-center">
                <div className="flex justify-start items-center mt-[30px] gap-[10px]">
                  <span className="bg-white-95 border-gray-100  lgg:ml-0 sm:ml-10 s flex justify-center items-center lgg:w-[107px] w-[86px] lgg:h-[43px] h-[34px] rounded text-[18px] text-grey-30">
                ...
                <div className="text-[16px] mt-3 pr-16 lgg:ml-0 sm:ml-10 ml-2 whitespace-nowrap  lgg:pr-2 font-bold sm:mt-8  text-grey-15">
                  {course.teacher}
                </div>
              </div>
              <div className=" mt-[24px] mx-auto lgg:mx-0 sm:mt-[30px]">
