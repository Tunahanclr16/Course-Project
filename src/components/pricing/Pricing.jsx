  ...
  return (
    <>
      <div className="flex flex-col">
        ...
        <div className="bg-[#FFFFFF]  w-[357px] pl-1 lgg:px-2  sm:h-[2106px] lgg:h-[1006px] sm:w-[609px] mx-auto flex  lg:w-[1100px] lgg:w-[1597px] flex-col gap-5 lgg:flex-row mt-8">
